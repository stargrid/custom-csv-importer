...
const defaultCsvMock = [{
  column_id: 1,
  column_name: 'Default Item 1',
  required: true
}, {
  column_id: 2,
  column_name: 'Default Item 2',
  required: false
}];
const userCsvMock = [{
  column_id: 1,
  column_name: 'User Item 1'
}, {
  column_id: 2,
  column_name: 'User Item 2'
}];
...
function App(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(Container, null, /*#__PURE__*/_react.default.createElement(Items, null, /*#__PURE__*/_react.default.createElement(Title, null, defaultCsvTitle), defaultCsv.map((item, index) => /*#__PURE__*/_react.default.createElement(_Box.default, _extends({
    key: index,
  ...
  }, props)))), /*#__PURE__*/_react.default.createElement(Items, null, /*#__PURE__*/_react.default.createElement(Title, null, userCsvTitle), userCsv.map((item, index) => /*#__PURE__*/_react.default.createElement(_Box.default, _extends({
    key: index,
    text: item.column_name,
    addArrow: addArrow,
    handler: 'left',
